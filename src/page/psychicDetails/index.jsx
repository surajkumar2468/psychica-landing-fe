...
const Index = () => {
  ...
  const getProfessionalDetail = () => {
    setLoader(true);
    axiosInstance
      .get(`${API_URLS.psychicDetails}${id}`)
      .then((res) => {
        console.log("RES", res);
        setLoader(false);
        setDetails(res);
        ...
        <div>
          <section className="psychic_details">
            <div className="container">
              <div className="back_btn cursor-pointer">
                <a onClick={() => navigate(-1)}>
                  <img src="/images/icon_arrow.svg" alt="" />
                  Back to{" "}
                  {queryParams.get("previous")
                    ? queryParams.get("previous")
                    : queryParams.get("type").charAt(0).toUpperCase() +
                      queryParams.get("type").slice(1).toLowerCase()}{" "}
                  Psychics
                </a>
              </div>
              <div className="img_explore_sec">
                ...
                <p>
                  ...
                  Identity verified{" "}
                  <img
                    src="/images/shape_star.svg"
                    alt=""
                    className="shape_star"
                  />
                ...
                <div className="col-12 col-md-7 pe-md-5">
                  <div className="psychic_details2_left">
                    ...
                    <ul className="psychic_details2_ul d-flex flex-column align-left">
                      <li>
                        <img src="/images/readingtype.svg" alt="" />
                      ...
                      <li className="d-flex flex-wrap">
                        <img src="/images/type_icon.svg" alt="" />
                    ...
                    <ul className="psychic_details2_ul2">
                      {details?.specialities?.map((ele) => {
                        return (
                          <li>
                            <img src="/images/tarotcards.svg" alt="" />
                            {ele}
                          </li>
                        );
                      })}
