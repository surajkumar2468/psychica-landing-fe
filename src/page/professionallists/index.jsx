...
const ProfessionalLists = () => {
  ...
  let heading = queryParams
  console.log("QUERYPARAMS",heading);
  ...
  const typeName = queryParams.get("type") == "READING_TOPIC" ? "Reading Topic" : queryParams.get("type")
  const ren = typeName.toLowerCase();
  // const ren = typeName.charAt(0).toUpperCase() + typeName.slice(1);
          ...
          <section className="explore_category_sec">
            <div className="container">
             <h2>Explore  {ren} psychics</h2>
              ...
              {/* <h2 classNam="typeHeading">{`Explore ${queryParams.get("type")} Psychics`}</h2> */}
              <div className="row">
                    ...
                    <div className="category__right_row1">
                      <div>
                        ...
                        <div className="star__rating">
                          ...
                          {`${recommendedPsychic?.average_rating}`}{" "}
                          ...
                          <a
                            ...
                            onClick={() =>
                              handleBookappointment(
                                ...
                                recommendedPsychic?.price,
                                recommendedPsychic?.type,
